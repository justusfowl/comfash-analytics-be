    ...
    def _get_all_items(self,page,main_directory,dir_name,limit,arguments):
        ...
        while count < limit+1:
            ...
            if object == "no_links":
                ...
                #     url_paths.append(object['image_link'])
                # else:
                #     errorCount += 1

                # for simplicity, just provide image_link
                count += 1
                url_paths.append(object['image_link'])
        ...
        return items,errorCount,abs_path, url_paths, all_objects


    # Bulk Download
    def download(self,arguments,channel,userId):
        ...
        for pky in prefix_keywords:
            for sky in suffix_keywords:     # 1.for every suffix keywords
                ...
                while i < len(search_keyword):      # 2.for every main keyword
                    ...
                    items,errorCount,abs_path,url_paths,all_objects = self._get_all_items(raw_html,main_directory,dir_name,limit,arguments)    #get all image items and download images
        ...
        if arguments['print_paths']:
            print(paths)
        return paths, url_paths, all_objects